...
//  drv_esp8266_init(&g_sUART2, "CMCC-2.4G", "123456789");
  ...
  //MQTT 参数配置
  drv_server_init();
//  drv_server_set_gw_sn(0xA1080123);//测试
//  drv_server_set_app_id(123000);
  ...
  drv_server_cmd_parse_register(app_th01_recv_parse);//服务端应用层命令解析函数注册   

  //QT C++模型 ModelTh01里的密码,实际使用可以做个混淆
