 ...
 * SX1278 definitions
 */
#define RF_MID_BAND_THRESH                          550000000   // 

#define     XTAL_FREQ               (32)        // MHz
 ...
 * RegOpMode
 */
#define RFLR_OPMODE_LONGRANGEMODE_MASK              0x7F //调制模式掩码
#define RFLR_OPMODE_LONGRANGEMODE_OFF               0x00 // Default FSK/OOK模式
#define RFLR_OPMODE_LONGRANGEMODE_ON                0x80 //Lora模式

#define RFLR_OPMODE_ACCESSSHAREDREG_MASK            0xBF //掩码
#define RFLR_OPMODE_ACCESSSHAREDREG_ENABLE          0x40 //使能Lora模式下访问FSK寄存器页面
#define RFLR_OPMODE_ACCESSSHAREDREG_DISABLE         0x00 // Default

#define RFLR_OPMODE_FREQMODE_ACCESS_MASK            0xF7//高低频掩码
#define RFLR_OPMODE_FREQMODE_ACCESS_LF              0x08 // Default 低频模式
#define RFLR_OPMODE_FREQMODE_ACCESS_HF              0x00 //高频模式

#define RFLR_OPMODE_MASK                            0xF8 //工作模式掩码
#define RFLR_OPMODE_SLEEP                           0x00 //睡眠模式
#define RFLR_OPMODE_STANDBY                         0x01 // Default 待机模式
#define RFLR_OPMODE_SYNTHESIZER_TX                  0x02 //频率合成器发送(FSTx)
#define RFLR_OPMODE_TRANSMITTER                     0x03 //发送(Tx)
#define RFLR_OPMODE_SYNTHESIZER_RX                  0x04 //频率合成器接收(FSRx)
#define RFLR_OPMODE_RECEIVER                        0x05 //连续接收
// LoRa specific modes
#define RFLR_OPMODE_RECEIVER_SINGLE                 0x06 //单次接收
#define RFLR_OPMODE_CAD                             0x07 //信道活动检测(CAD)
